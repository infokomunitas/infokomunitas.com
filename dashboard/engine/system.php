...
if (is_array($CONFIG)) {
	...
	if ($CONFIG['dashboard']['app_underdevelopment'] == TRUE) under_development();
...
if (isset($validation)) {
	...
	$setPage = $CONFIG['dashboard']['default_view'];
	$setFunction = 'index';

}

// pr($validation);exit;
$DATA['dashboard']['page'] = @$setPage ;
$DATA['dashboard']['function'] = @$setFunction ;
$DATA['dashboard']['uri'] = @$validation ;
