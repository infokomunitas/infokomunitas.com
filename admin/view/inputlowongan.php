...
<div id="content-container">
	<form id="validate-enhanced" class="form parsley-form" method="post" action="<?=$basedomain?>lowongan/articleinp" enctype="multipart/form-data">
						...
						<div class="col-md-6">
							...
							<label for="select-input">Jenis Artikel</label>
									<select name="categoryid" class="form-control">
										<option value='2' >Lowongan</option>
